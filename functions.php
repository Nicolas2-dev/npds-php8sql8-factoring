...
function smilie($message) {
   // Tranforme un :-) en IMG
   global $theme;
   if ($ibid=theme_image("forum/smilies/smilies.php")) {$imgtmp="themes/$theme/images/forum/smilies/";} else {$imgtmp="assets/images/forum/smilies/";}
   ...
   if ($ibid=theme_image("forum/smilies/more/smilies.php")) {$imgtmp="themes/$theme/images/forum/smilies/more/";} else {$imgtmp="assets/images/forum/smilies/more/";}
   if (file_exists($imgtmp."smilies.php")) {
      include ($imgtmp."smilies.php");
      foreach ($smilies AS $tab_smilies) {
         $message = str_replace($tab_smilies[0], "<img class='n-smil' src='".$imgtmp.$tab_smilies[1]."' loading='lazy' />", $message);
...
function emotion_add($image_subject) {
   ...
   if ($ibid=theme_image('forum/subject/index.html')) {$imgtmp="themes/$theme/images/forum/subject";} else {$imgtmp='assets/images/forum/subject';}
...
function member_qualif($poster, $posts, $rank) {
   global $anonymous;
   $tmp='';
   if ($ibid=theme_image('forum/rank/post.gif')) $imgtmpP=$ibid; else $imgtmpP='assets/images/forum/rank/post.gif';
   ...
   if ($poster!=$anonymous) {
      ...
      if ($rank) {
         if ($ibid=theme_image("forum/rank/".$rank.".gif") or $ibid=theme_image("forum/rank/".$rank.".png")) $imgtmpA=$ibid; else $imgtmpA="assets/images/forum/rank/".$rank.".png";
         $rank='rank'.$rank;
         global $$rank;
...
function sub_forum_folder($forum) {
   ...
   if ($ibid=theme_image("forum/icons/red_sub_folder.gif")) {$imgtmpR=$ibid;} else {$imgtmpR="assets/images/forum/icons/red_sub_folder.gif";}
   if ($ibid=theme_image("forum/icons/sub_folder.gif")) {$imgtmp=$ibid;} else {$imgtmp="assets/images/forum/icons/sub_folder.gif";}
