...
function member_qualif($poster, $posts, $rank)
{
    global $anonymous;
    $tmp = '';
    if ($ibid = theme_image('forum/rank/post.gif')) $imgtmpP = $ibid;
    else $imgtmpP = 'assets/images/forum/rank/post.gif';
    ...
    if ($poster != $anonymous) {
        ...
        if ($rank) {
            if ($ibid = theme_image("forum/rank/" . $rank . ".gif") or $ibid = theme_image("forum/rank/" . $rank . ".png")) $imgtmpA = $ibid;
            else $imgtmpA = "assets/images/forum/rank/" . $rank . ".png";
            $rank = 'rank' . $rank;
            global $$rank;
