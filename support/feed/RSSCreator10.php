...
class RSSCreator10 extends FeedCreator
{
    ...
    function createFeed()
    {
        ...
        $now = new FeedDate();
        $feed .= "       <dc:date>" . htmlspecialchars( (string) $now->iso8601(), ENT_COMPAT | ENT_HTML401, $this->encoding) . "</dc:date>\n";
        $feed .= "        <items>\n";
        $feed .= "            <rdf:Seq>\n";
        ...
        for ($i = 0; $i < count($this->items); $i++) {
            ...
            if ($this->items[$i]->date != null) {
                ...
                $feed .= "        <dc:date>" . htmlspecialchars( (string) $itemDate->iso8601(), ENT_COMPAT | ENT_HTML401, $this->encoding) . "</dc:date>\n";
            }
