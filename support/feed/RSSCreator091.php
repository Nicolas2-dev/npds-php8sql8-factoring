...
use npds\support\feed\FeedDate;
use npds\support\feed\FeedCreator;
...
class RSSCreator091 extends FeedCreator
{
    ...
    function createFeed()
    {
        ...
        $now = new FeedDate();
        $feed .= "        <lastBuildDate>" . htmlspecialchars( (string) $now->rfc822(), ENT_COMPAT | ENT_HTML401, $this->encoding) . "</lastBuildDate>\n";
        ...
        if ($this->pubDate != "") {
            ...
            $feed .= "        <pubDate>" . htmlspecialchars( (string) $pubDate->rfc822(), ENT_COMPAT | ENT_HTML401, $this->encoding) . "</pubDate>\n";
        }
        ...
        for ($i = 0; $i < count($this->items); $i++) {
            ...
            if ($this->items[$i]->date != "") {
                ...
                $feed .= "            <pubDate>" . htmlspecialchars( (string) $itemDate->rfc822(), ENT_COMPAT | ENT_HTML401, $this->encoding) . "</pubDate>\n";
            }
