...
use Npds\Hashing\HasherInterface;
...
class SessionGuard extends Guard
{
     ...
     *
     * @var \Npds\Hashing\HasherInterface
     */
    protected $hasher;
     ...
     * @param  string  $name
     * @param  string  $model
     * @param  \Npds\Session\Store  $session
     * @param  \Npds\Cookie\CookieJar  $cookies
     * @param  \Npds\Hashing\HasherInterface  $hasher
    ...
    {
        $password = Arr::array_get($credentials, 'password');
