...
class ViewErrorBag implements Countable
{
    ...
    {
        return Arr::array_get($this->bags, $key, new MessageBag());
    }
     ...
     *
     * @param  string  $key
     * @param  \Npds\Support\MessageBag  $bag
     * @return $this
     */
     ...
     *
     * @param  string  $key
     * @param  \Npds\Support\MessageBag  $value
     * @return void
     */
    public function __set($key, $value)
    {
        Arr::array_set($this->bags, $key, $value);
    }
