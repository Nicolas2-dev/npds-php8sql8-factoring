...
class Request extends SymfonyRequest
{
    ...
    {
        return Arr::array_get($this->segments(), $index - 1, $default);
    }
    ...
    public function only($keys)
    {
        ...
        return Arr::array_only($this->input(), $keys) + array_fill_keys($keys, null);
    }
    ...
    {
        return Arr::array_get($this->files->all(), $key, $default);
    }
    ...
    public function json($key = null, $default = null)
    {
        ...
        return Arr::array_get($this->json->all(), $key, $default);
    }
     ...
     *
     * @return \Npds\Routing\Route|mixed
     */
    public function route($parameter = null)
    {
        $resolver = $this->getRouteResolver();

        if (is_null($route = call_user_func($resolver))) {
            return;
        }

        // We have a valid Route instance.
    ...
    public function fingerprint()
    {
        ...
        return sha1(implode('|', array_merge(
            $route->methods(), array($route->uri(), $this->ip())
        )));
    }
