...
use Npds\Translation\Translator;
...
class Validator
{
     ...
     *
     * @var \Npds\Translation\Translator
     */
     ...
     *
     * @var \Npds\Validation\DatabasePresenceVerifier
     */
     ...
     *
     * @var \Npds\Validation\MessageFormatter
     */
     ...
     *
     * @param  \Npds\Translation\Translator  $translator
     * @param  array  $data
     * @param  array  $rules
    ...
    {
        $current = Arr::array_get($this->rules, $attribute, array());
    ...
    protected function makeReplacements($message, $attribute, $rule, $parameters)
    {
        ...
        if (! is_null($callback = Arr::array_get($this->replacers, $lowerRule))) {
    ...
    {
        if (! is_null($value = Arr::array_get($this->data, $attribute))) {
            return $value;
        } else if (! is_null($value = Arr::array_get($this->files, $attribute))) {
            return $value;
        }
    }
    ...
    protected function validateRequiredIf($attribute, $value, $parameters)
    {
        ...
        if ($parameters[1] == Arr::array_get($this->data, $parameters[0])) {
            return $this->validateRequired($attribute, $value);
        }
    ...
    protected function validateSame($attribute, $value, $parameters)
    {
        ...
        $other = Arr::array_get($this->data, $parameters[0]);
    ...
    protected function getSize($attribute, $value)
    {
        if (is_numeric($value) && $this->hasRule($attribute, $this->numericRules)) {
            return Arr::array_get($this->data, $attribute);
        }
     ...
     *
     * @param  array  $rules
     * @return \Npds\Validation\Validator
     */
     ...
     *
     * @return \Npds\Validation\DatabasePresenceVerifier
     *
     ...
     *
     * @param  \Npds\Validation\DatabasePresenceVerifier  $presenceVerifier
     * @return void
     */
     ...
     *
     * @return \Npds\Translation\Translator
     */
    ...
    public function __call($method, $parameters)
    {
        ...
        if (! is_null($callback = Arr::array_get($this->extensions, $rule))) {
