...
use Npds\Pagination\Paginator;
use Npds\Pagination\SimplePaginator;
...
class Builder
{
     ...
     *
     * @var Npds\Database\ORM\Relation
     */
    public $relation;
     ...
     *
     * @var \Npds\Database\Query\Builder
     */
    public $query;
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \Npds\Database\ORM\Model|static
     *
     ...
     * @return \Npds\Database\ORM\Model|static|mixed
     */
     ...
     * @param  int|null  $page
     * @return \Npds\Pagination\Paginator
     *
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \Npds\Pagination\SimplePaginator
     */
    ...
    protected function addUpdatedAtColumn(array $values)
    {
        ...
        return Arr::array_add($values, $column, $this->model->freshTimestampString());
    }
     ...
     * @param  array  $columns
     * @param  \Closure|null  $callback
     * @return \Npds\Database\ORM\Model[]
     */
     ...
     * @return \Npds\Database\ORM\Relations\Relation
     */
     ...
     *
     * @return \Npds\Database\Query\Builder|static
     */
     ...
     *
     * @param  \Npds\Database\ORM\Model  $model
     * @return $this
     */
     ...
     *
     * @param  \Npds\Database\ORM\Relation  $relation
     * @return $this
     */
