...
class Connector
{
    ...
    public function connect(array $config)
    {
        ...
        if (! is_null($collation = Arr::array_get($config, 'collation'))) {
    ...
    {
        $options = Arr::array_get($config, 'options', array());
    ...
    {
        $username = Arr::array_get($config, 'username');
        $password = Arr::array_get($config, 'password');
