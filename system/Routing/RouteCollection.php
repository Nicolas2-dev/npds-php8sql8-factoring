...
class RouteCollection implements Countable
{
    ...
    protected function findRoute(array $routes, Request $request)
    {
        ...
        if (! is_null($route = Arr::array_get($routes, $path = rawurldecode($path)))) {
            return $route->matched();
        }

        $orderedRoutes = $this->prepareRoutes($routes);

        return Arr::array_first($orderedRoutes, function ($uri, $route) use ($path)
        {
    ...
    {
        return Arr::array_has($this->namedRoutes, $name);
    }
    ...
    {
        return Arr::array_get($this->namedRoutes, $name);
    }
    ...
    protected function get($method = null)
    {
        ...
        return Arr::array_get($this->routes, $method, array());
    }
