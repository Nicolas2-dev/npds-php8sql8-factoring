...
use Npds\Routing\RouteCollection;
...
class UrlGenerator
{
     ...
     *
     * @param  \Npds\Routing\RouteCollection   $routes
    ...
    public function route($name, $parameters = array())
    {
        ...
        $uri = preg_replace_callback('#/\{(.*?)(\?)?\}#', function ($matches) use (&$parameters)
        {
            ...
            $value = Arr::array_pull($parameters, $name, ($optional === false) ? $original : '');
     ...
     *
     * @return \Npds\Session\Store|null
     */
