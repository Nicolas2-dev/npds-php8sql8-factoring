...
use Npds\Http\Exception\HttpResponseException;
...
class Route
{
    ...
    protected function resolveCallParameters(array $parameters, ReflectionFunctionAbstract $reflector)
    {
        foreach ($reflector->getParameters() as $offset => $parameter) {
            ...
            if (! is_null($classname = $parameter->getType()->getName())) {
    ...
    protected function resolveActionCallback()
    {
        ...
        $callback = Arr::array_get($this->action, 'uses');
    ...
    public function getMiddleware()
    {
        ...
        $middleware = Arr::array_get($this->action, 'middleware', array());
    ...
    public function parameter($name = null, $default = null)
    {
        ...
        return Arr::array_get($parameters, $name, $default);
    }
    ...
    {
        return Arr::array_get($this->action, 'as');
    }
