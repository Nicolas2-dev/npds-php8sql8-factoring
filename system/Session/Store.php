...
use Npds\Session\ExistenceAwareInterface;
...
class Store implements SessionInterface
{
    ...
    {
        return Arr::array_get($this->attributes, $name, $default);
    }
    ...
    {
        return Arr::array_pull($this->attributes, $key, $default);
    }
    ...
    {
        Arr::array_set($this->attributes, $name, $value);
    }
    ...
    {
        return Arr::array_pull($this->attributes, $name);
    }
    ...
    {
        Arr::array_forget($this->attributes, $key);
    }
    ...
    {
        return Arr::array_get($this->bags, $name, function()
        {
    ...
    {
        return Arr::array_get($this->bagData, $name, array());
    }
