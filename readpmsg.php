...
if (!$user)
    ...
    if ($dossier == 'All') $Xdossier = translate("Tous les sujets");
    else $Xdossier = StripSlashes($dossier);
    echo '
    ...
    if (!sql_num_rows($resultID))
        ...
        if ($posterdata['user_avatar'] != '') {
            if (stristr($posterdata['user_avatar'], "users_private"))
                ...
                if ($ibid = theme_image("forum/avatar/" . $posterdata['user_avatar'])) $imgtmp = $ibid;
            else $imgtmp = "assets/images/forum/avatar/" . $posterdata['user_avatar'];
        ...
        if ($smilies) {
            if ($myrow['msg_image'] != '') {
                ...
                if ($ibid = theme_image("forum/subject/00.png")) $imgtmpPI = $ibid;
                else $imgtmpPI = "assets/images/forum/subject/00.png";
