...
class ModuleServiceProvider extends ServiceProvider
{
    ...
    protected $providers = array(
        'Modules\TwoUsers\Providers\AuthServiceProvider',
        'Modules\TwoUsers\Providers\EventServiceProvider',
        'Modules\TwoUsers\Providers\RouteServiceProvider',
        'Modules\TwoUsers\Library\User\UserServiceProvider',
        'Modules\TwoUsers\Library\Online\OnlineServiceProvider',
    );
    ...
    public function boot()
    {
        ...
        $this->package('Modules/TwoUsers', 'two_users', $path);
