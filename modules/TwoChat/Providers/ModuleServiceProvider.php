...
class ModuleServiceProvider extends ServiceProvider
{
    ...
    protected $providers = array(
        'Modules\TwoChat\Providers\AuthServiceProvider',
        'Modules\TwoChat\Providers\EventServiceProvider',
        'Modules\TwoChat\Providers\RouteServiceProvider',
    );
    ...
    public function boot()
    {
        ...
        $this->package('Modules/TwoChat', 'two_chat', $path);
