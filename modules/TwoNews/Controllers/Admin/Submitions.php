...
class Submitions extends AdminController
{
    ...
    {
        $this->f_meta_nom = 'submissions';

        $this->f_titre = __d('two_news', 'Article en attente de validation');
