...
class ModuleServiceProvider extends ServiceProvider
{
    ...
    protected $providers = array(
        'Modules\TwoNews\Providers\AuthServiceProvider',
        'Modules\TwoNews\Providers\EventServiceProvider',
        'Modules\TwoNews\Providers\RouteServiceProvider',
        'Modules\TwoNews\Library\News\NewsServiceProvider',
    );
    ...
    public function boot()
    {
        ...
        $this->package('Modules/TwoNews', 'two_news', $path);
