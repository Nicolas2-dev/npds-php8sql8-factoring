...
function ins_translate($phrase) {
 switch($phrase) {
  ...
  case "Le fichier 'config/cache.config.php' est introuvable !": $tmp = "El archivo 'config/cache.config.php' no encontrado"; break;
  case "Le fichier 'config/config.php' est introuvable !": $tmp = "El archivo 'config/config.php' no encontrado"; break;
  case "Le fichier 'config/filemanager.php' est introuvable !": $tmp = "El archivo 'config/filemanager.php' no encontrado"; break;
  case "Le fichier 'logs/security.log' est introuvable !": $tmp = "El archivo 'logs/security.log' no encontrado"; break;
  case "Le fichier 'storage/meta/meta.php' est introuvable !": $tmp = "El archivo 'storage/meta/meta.php' no encontrado"; break;
  case "Le fichier 'modules/upload/config/upload.conf.php' est introuvable !": $tmp = "El archivo 'abla.log.php' no encontrado"; break;
  case "Le fichier 'storage/static/edito_membres.txt' est introuvable !": $tmp = "El archivo 'storage/static/edito_membres.txt' no encontrado'"; break;
  case "Le fichier 'storage/static/edito.txt' est introuvable !": $tmp = "El archivo 'storage/static/edito.txt' no encontrado"; break;
  ...
  case "Le fichier de configuration n'a pas pu être modifié. Vérifiez les droits d'accès au fichier 'config/config.php', puis réessayez à nouveau.": $tmp = "El archivo de configuración no puede ser modificado. Compruebe los derechos de acceso al archivo 'config/config.php', y luego vuelve a intentarlo."; break;
