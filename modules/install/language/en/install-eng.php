...
function ins_translate($phrase) {
 switch($phrase) {
  ...
  case "Le fichier 'config/cache.config.php' est introuvable !": $tmp = "The file 'config/cache.config.php' is missing !"; break;
  case "Le fichier 'config/config.php' est introuvable !": $tmp = "The file 'config/config.php' is missing !"; break;
  case "Le fichier 'config/filemanager.php' est introuvable !": $tmp = "The file 'config/filemanager.php' is missing !"; break;
  case "Le fichier 'logs/security.log' est introuvable !": $tmp = "The file 'logs/security.log' is missing !"; break;
  case "Le fichier 'storage/meta/meta.php' est introuvable !": $tmp = "The file 'storage/meta/meta.php' is missing !"; break;
  case "Le fichier 'modules/upload/config/upload.conf.php' est introuvable !": $tmp = "The file 'modules/upload/config/upload.conf.php' is missing !"; break;
  case "Le fichier 'storage/static/edito_membres.txt' est introuvable !": $tmp = "The file 'storage/static/edito_membres.txt' is missing !"; break;
  case "Le fichier 'storage/static/edito.txt' est introuvable !": $tmp = "The file 'storage/static/edito.txt' is missing !"; break;
  case "Le fichier de configuration a été écrit avec succès !": $tmp = "The config file was written successfully !"; break;
  case "Le fichier de configuration n'a pas pu être modifié. Vérifiez les droits d'accès au fichier 'config/config.php', puis réessayez à nouveau.": $tmp = "The config file can not be modicated. Please, verify the rights of access of the file 'config/config.php', and submit again."; break;
