...
function etape_5()
{
    ...
    echo '
                ...
                <div class="col-sm-12">
                    ...
                    <div class="form-floating mb-3">
                        <input class="form-control" type="text" name="new_sitename" id="new_sitename" maxlength="80" value="' . Config::get('app.sitename') . '" />
    ...
    for ($i = 0; $i < $themelistsize; $i++) {
        if ($themelist[$i] != '') {
            if ($themelist[$i] == 'npds-boost_sk') $sel = ' selected="selected"';
            else $sel = '';
            echo '
