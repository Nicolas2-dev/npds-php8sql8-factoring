...
namespace Modules\TwoPollbooth\Providers;
...
class ModuleServiceProvider extends ServiceProvider
{
    ...
    protected $providers = array(
        'Modules\TwoPollbooth\Providers\AuthServiceProvider',
        'Modules\TwoPollbooth\Providers\EventServiceProvider',
        'Modules\TwoPollbooth\Providers\RouteServiceProvider',
    );
    ...
    public function boot()
    {
        ...
        $this->package('Modules/TwoPollbooth', 'two_pollbooth', $path);
