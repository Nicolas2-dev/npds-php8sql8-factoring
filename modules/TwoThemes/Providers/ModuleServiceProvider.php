...
class ModuleServiceProvider extends ServiceProvider
{
    ...
    protected $providers = array(
        'Modules\TwoThemes\Providers\AuthServiceProvider',
        'Modules\TwoThemes\Providers\EventServiceProvider',
        'Modules\TwoThemes\Providers\RouteServiceProvider',
    );
    ...
    public function boot()
    {
        ...
        $this->package('Modules/TwoThemes', 'two_themes', $path);
    ...
    /**
     * Register the TwoThemes Module Service Provider.
     *
