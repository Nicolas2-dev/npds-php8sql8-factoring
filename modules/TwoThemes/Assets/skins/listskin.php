...
/************************************************************************/
   ...
   while (false!==($file = readdir($handle))) {
      if ( (!strstr($file,'.')) and (!strstr($file,'api')) and (!strstr($file,'bower_components')) and (!strstr($file,'assets')) and (!strstr($file,'fonts')) ) {
...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="<?php echo implode($result[1]); ?>assets/css/prism.css" />
   ...
   <body>
      ...
      <script type="text/javascript" src="<?php echo implode($result[1]); ?>assets/js/prism.js"></script>
