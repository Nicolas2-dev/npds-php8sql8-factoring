...
class ModuleServiceProvider extends ServiceProvider
{
    ...
    protected $providers = array(
        'Modules\TwoHeadlines\Providers\AuthServiceProvider',
        'Modules\TwoHeadlines\Providers\EventServiceProvider',
        'Modules\TwoHeadlines\Providers\RouteServiceProvider',
    );
    ...
    public function boot()
    {
        ...
        $this->package('Modules/TwoHeadlines', 'two_headlines', $path);
