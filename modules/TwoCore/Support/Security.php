...
class Security
{
     ...
     *
     * @param   string  $Xstring  [$Xstring description]
     *
     * @return  string
     */
    public static function remove(string $Xstring): string
    {
        if ($Xstring != '') {
            $npds_forbidden_words = array();
            $npds_forbidden_words = static::prepareForbidden($npds_forbidden_words);
            $npds_forbidden_words = array_merge($npds_forbidden_words, static::twoSanitize());
    ...
    /**
     * [prepareForbidden description]
     *
     * @param   [type]  $npds_forbidden_words  [$npds_forbidden_words description]
     *
     * @return  [type]                         [return description]
     */
    public static function prepareForbidden($npds_forbidden_words)
    {
        // NCRs 2 premières séquence = NCR (dec|hexa) correspondant aux caractères latin de la table ascii (code ascii entre 33 et 126)
        $npds_forbidden_words = array_merge($npds_forbidden_words, static::codeAscii());
        
        // 2 dernières séquences = NCR (dec|hexa) correspondant aux caractères latin du bloc unicode Halfwidth and Fullwidth Forms.
        $npds_forbidden_words = array_merge($npds_forbidden_words, static::codeHalfwidth());
        
        return $npds_forbidden_words;
    }

    /**
     * [twoSanitize description]
     *
     * @return  [type]  [return description]
     */
    public static function twoSanitize()
    {
        // two sanitize
        return array(
            "'from:'i"                      => "!from:!",
    ...
    /**
     * [asciiHack description]
     *
     * @return  [type]  [return description]
     */
    public static function codeAscii()
    {
        // NCRs 2 premières séquence = NCR (dec|hexa) correspondant aux caractères latin de la table ascii (code ascii entre 33 et 126)
        return array(
    ...
    /**
     * [codeHalfwidth description]
     *
     * @return  [type]  [return description]
     */
    public static function codeHalfwidth()
    {
        // 2 dernières séquences = NCR (dec|hexa) correspondant aux caractères latin du bloc unicode Halfwidth and Fullwidth Forms.
