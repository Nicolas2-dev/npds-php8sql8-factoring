...
namespace Modules\TwoCore\Controllers\Admin\User;
...
class EmailUser extends AdminController
{
    ...
    {
        $this->f_meta_nom = 'email_user';

        $this->f_titre = __d('two_core', 'Diffusion d\un Message Interne');
