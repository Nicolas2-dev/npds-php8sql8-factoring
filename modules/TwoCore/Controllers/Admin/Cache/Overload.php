...
namespace Modules\TwoCore\Controllers\Admin\Cache;
...
class Overload extends AdminController
{
    ...
    {
        $this->f_meta_nom = 'supercache';

        $this->f_titre = __d('two_core', 'SuperCache');
    ...
    public function supercache_empty()
    {
        cache::SC_clean();
