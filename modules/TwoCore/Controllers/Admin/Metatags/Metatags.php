...
namespace Modules\TwoCore\Controllers\Admin\Metatags;
...
class Metatags extends AdminController
{
    ...
    {
        $this->f_meta_nom = 'MetaTagAdmin';

        $this->f_titre = __d('two_core', 'Administration des MétaTags');
