...
namespace Modules\TwoNewsleter\Providers;
...
class ModuleServiceProvider extends ServiceProvider
{
    ...
    protected $providers = array(
        'Modules\TwoNewsleter\Providers\AuthServiceProvider',
        'Modules\TwoNewsleter\Providers\EventServiceProvider',
        'Modules\TwoNewsleter\Providers\RouteServiceProvider',
    );
    ...
    public function boot()
    {
        ...
        $this->package('Modules/TwoNewsleter', 'two_newsleter', $path);
