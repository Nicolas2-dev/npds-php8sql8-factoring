...
namespace Modules\TwoGroupes\Providers;
...
class ModuleServiceProvider extends ServiceProvider
{
    ...
    protected $providers = array(
        'Modules\TwoGroupes\Providers\AuthServiceProvider',
        'Modules\TwoGroupes\Providers\EventServiceProvider',
        'Modules\TwoGroupes\Providers\RouteServiceProvider',
        'Modules\TwoGroupes\Library\GroupeServiceProvider',
    );
    ...
    public function boot()
    {
        ...
        $this->package('Modules/TwoGroupes', 'two_groupes', $path);
