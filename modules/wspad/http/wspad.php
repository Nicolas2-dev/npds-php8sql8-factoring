...
function Page($page, $ranq)
{
    ...
    global $surlignage;
    echo '
    <hr /><h3>' . wspad_trans("Document : ") . '</h3><h4>' . $page . '<span class="text-muted">&nbsp;[ ' . wspad_trans("révision") . ' : ' . $row['ranq'] . ' - ' . $row['editedby'] . ' / ' . date(translate("dateinternal"), $row['modtime'] + ((int)$gmt * 3600)) . ' ] </span> <span class="float-end"><img src="modules/' . $ModPath . '/images/ajax_waiting.gif" id="verrous" title="wspad locks" /></span></h4>
