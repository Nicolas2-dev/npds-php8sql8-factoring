...
class ModuleServiceProvider extends ServiceProvider
{
    ...
    protected $providers = array(
        'Modules\TwoBlocnotes\Providers\AuthServiceProvider',
        'Modules\TwoBlocnotes\Providers\EventServiceProvider',
        'Modules\TwoBlocnotes\Providers\RouteServiceProvider',
    );
