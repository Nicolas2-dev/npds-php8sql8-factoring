...
class ModuleServiceProvider extends ServiceProvider
{
    ...
    protected $providers = array(
        'Modules\TwoBlocks\Providers\AuthServiceProvider',
        'Modules\TwoBlocks\Providers\EventServiceProvider',
        'Modules\TwoBlocks\Providers\RouteServiceProvider',
        'Modules\TwoBlocks\Library\BlockServiceProvider',
    );
    ...
    public function boot()
    {
        ...
        $this->package('Modules/TwoBlocks', 'two_blocks', $path);
