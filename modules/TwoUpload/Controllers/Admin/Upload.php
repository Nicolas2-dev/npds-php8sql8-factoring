...
namespace Modules\TwoUpload\Controllers\Admin;
...
class Upload extends AdminController
{
    ...
    {
        $this->f_meta_nom = 'upConfigure';

        $this->f_titre = __d('two_upload', 'Configuration Upload');
    ...
    function upConfigure($ModPath, $ModStart, $f_meta_nom, $f_titre, $adminimg)
    {
        ...
        foreach ($hrchoice as $k => $af) {
            if ($ed_profil[$k] == "1") $sel = 'selected="selected"';
            else $sel = '';
            $opt .= '
