...
namespace Modules\TwoDownload\Providers;
...
class ModuleServiceProvider extends ServiceProvider
{
    ...
    protected $providers = array(
        'Modules\TwoDownload\Providers\AuthServiceProvider',
        'Modules\TwoDownload\Providers\EventServiceProvider',
        'Modules\TwoDownload\Providers\RouteServiceProvider',
    );
    ...
    public function boot()
    {
        ...
        $this->package('Modules/TwoDownload', 'two_download', $path);
