...
namespace Modules\TwoMessenger\Providers;
...
class ModuleServiceProvider extends ServiceProvider
{
    ...
    protected $providers = array(
        'Modules\TwoMessenger\Providers\AuthServiceProvider',
        'Modules\TwoMessenger\Providers\EventServiceProvider',
        'Modules\TwoMessenger\Providers\RouteServiceProvider',
    );
    ...
    public function boot()
    {
        ...
        $this->package('Modules/TwoMessenger', 'two_messenger', $path);
