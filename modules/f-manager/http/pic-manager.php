...
$inclusion = false;
if (file_exists("themes/$Default_Theme/view/modules/f-manager/pic-manager.html"))
    $inclusion = "themes/$Default_Theme/view/modules/f-manager/pic-manager.html";
elseif (file_exists("themes/default/view/modules/f-manager/pic-manager.html"))
    $inclusion = "themes/default/view/modules/f-manager/pic-manager.html";
else
