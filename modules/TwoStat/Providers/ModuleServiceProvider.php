...
class ModuleServiceProvider extends ServiceProvider
{
    ...
    protected $providers = array(
        'Modules\TwoStat\Providers\AuthServiceProvider',
        'Modules\TwoStat\Providers\EventServiceProvider',
        'Modules\TwoStat\Providers\RouteServiceProvider',
    );
    ...
    public function boot()
    {
        ...
        $this->package('Modules/TwoStat', 'two_stat', $path);
