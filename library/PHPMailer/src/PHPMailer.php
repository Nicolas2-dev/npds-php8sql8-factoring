...
class PHPMailer
{
     ...
     *
     * @see https://tools.ietf.org/view/rfc5322#section-3.6.4
     *
     * @var string
     */
    public $MessageID = '';
     ...
     *
     * @see https://tools.ietf.org/view/rfc3461 See section 4.1 for more information about NOTIFY
     */
    public $dsn = '';
    ...
    protected function sendmailSend($header, $body)
    {
        ...
        //Exim docs: http://www.exim.org/exim-html-current/doc/view/spec_html/ch-the_exim_command_line.html
    ...
    {
        //Matches scheme definition from https://tools.ietf.org/view/rfc3986#section-3.1
    ...
    public function createHeader()
    {
        ...
        //https://tools.ietf.org/view/rfc5322#section-3.6.4
        if (
            '' !== $this->MessageID &&
            preg_match(
                '/^<((([a-z\d!#$%&\'*+\/=?^_`{|}~-]+(\.[a-z\d!#$%&\'*+\/=?^_`{|}~-]+)*)' .
     ...
     *
     * @see http://tools.ietf.org/view/rfc2047#section-4.2
     *
     * @param string $str      the text to encode
     ...
     *
     * @see https://tools.ietf.org/view/rfc6376#section-3.4.2
     *
    ...
    public function DKIM_HeaderC($signHeader)
    {
        ...
        //@see https://tools.ietf.org/view/rfc5322#section-2.2
     ...
     *
     * @see https://tools.ietf.org/view/rfc6376#section-3.4.3
     *
     * @param string $body Message Body
     *
     * @return string
    ...
    public function DKIM_Add($headers_line, $subject, $body)
    {
        ...
        //Recommended list from https://tools.ietf.org/view/rfc6376#section-5.4.1
        $autoSignHeaders = [
            'from',
            'to',
            'cc',
        ...
        //https://tools.ietf.org/view/rfc6376#section-3.5
