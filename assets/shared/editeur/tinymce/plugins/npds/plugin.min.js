         ...
         var items = [
            {
               ...
               onAction: function () {
                  editor.insertContent('&nbsp;[fr] [/fr]&nbsp;[en] [/en]&nbsp;[es] [/es]&nbsp;[de] [/de]&nbsp;[zh] [/zh]&nbsp;');
               }
            },
            {
               type: 'menuitem',
