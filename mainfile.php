...
include("library/cache/cache.php");
...
if ($mysql_i==1)
   ...
   include("library/database/mysql.php");
...
function language_iso($l,$s,$c) {
   ...
   switch ($select_lang) {
      ...
      case "fr": $iso_lang ='fr';$iso_country='FR'; break;
      case "en": $iso_lang ='en';$iso_country='US'; break;
      case "es": $iso_lang ='es';$iso_country='ES'; break;
      case "de": $iso_lang ='de';$iso_country='DE'; break;
      case "zh": $iso_lang ='zh';$iso_country='CN'; break;
...
function languageList()
{
   ...
   $languages = include_once('config/languages.php');
   foreach($languages as $code => $lang) {
      $languageslist .= "$code ";
   }

   $file=fopen('storage/language/langcode.php', 'w');
...
function aff_localzone_langue($ibid) {
   ...
   $flag = array('fr'=>'fr_🇫🇷','es'=>'es_🇪🇸','de'=>'de_🇩🇪','en'=>'en_🇺🇸','zh'=>'zh_🇨🇳');
   $M_langue= '
   <div class="mb-3">
...
function blockSkin()
{
   global $Default_Skin, $Default_Theme, $user;
   $skinOn = '';
   if ($user) {
...
function themeLists($implode=false, $separator = ' ')
{
