...
class SuperCacheManager
{
     ...
     *
     * @var SuperCacheManager
     */
    private static ?SuperCacheManager  $instance = null;
    ...
    /**
     * instance SuperCacheManager
     *
     * @return SuperCacheManager
     */
    public static function setInstance($config): SuperCacheManager
    {
     ...
     * @return SuperCacheManager
     */
    public static function getInstance(): SuperCacheManager
    {
        return static::$instance;
    }
