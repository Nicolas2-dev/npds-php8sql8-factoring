...
use Npds\Foundation\Exceptions\HandlerInterface;
use Npds\Foundation\Exceptions\Handler as BaseHandler;
...
class Handler extends BaseHandler implements HandlerInterface
{
    ...
    protected $dontReport = array(
        'Npds\Session\TokenMismatchException',
        'Npds\Auth\AuthenticationException,',
     ...
     *
     * @param  \Npds\Http\Request  $request
     * @param  \Npds\Auth\AuthenticationException  $exception
