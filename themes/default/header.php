...
';
   ...
   if (file_exists("themes/$tmp_theme/view/include/body_onload.inc")) {
      echo $body_onloadH;
      include ("themes/$tmp_theme/view/include/body_onload.inc");
      echo $body_onloadF;
   }
   ...
   if (file_exists("themes/$tmp_theme/view/include/header_head.inc")) {include ("themes/$tmp_theme/view/include/header_head.inc");}
   ...
   if ($js) {
      ...
      <script type="text/javascript" src="'.$tab_js.'"></script>';
               ...
               if (file_exists("themes/$tmp_theme/assets/js/$tab_js") and ($tab_js!=''))
                  echo '
      <script type="text/javascript" src="themes/'.$tmp_theme.'/assets/js/'.$tab_js.'"></script>';
      ...
      <script type="text/javascript" src="'.$tab_js.'"></script>';
         ...
         if (file_exists("themes/$tmp_theme/assets/js/$js"))
            echo '
      <script type="text/javascript" src="themes/'.$tmp_theme.'/assets/js/'.$js.'"></script>';
