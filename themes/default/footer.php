...
if (file_exists("themes/default/view/include/footer_before.inc")) include("themes/default/view/include/footer_before.inc");
foot();
// include externe file from modules/themes include for functions, codes ...
if (isset($user)) {
    if (file_exists("themes/$cookie9/view/include/footer_after.inc")) include("themes/$cookie9/view/include/footer_after.inc");
    else
            if (file_exists("themes/default/view/include/footer_after.inc")) include("themes/default/view/include/footer_after.inc");
} else {
    if (file_exists("themes/$Default_Theme/view/include/footer_after.inc")) include("themes/$Default_Theme/view/include/footer_after.inc");
    else
            if (file_exists("themes/default/view/include/footer_after.inc")) include("themes/default/view/include/footer_after.inc");
}
echo '
