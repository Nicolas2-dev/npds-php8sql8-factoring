...
function importExternalJavacript()
{
    ...
    if (file_exists("themes/default/view/include/body_onload.inc")) {
        echo $body_onloadH;
        include("themes/default/view/include/body_onload.inc");
        echo $body_onloadF;
    }

    if (file_exists("themes/$theme/view/include/body_onload.inc")) {
        echo $body_onloadH;
        include("themes/$theme/view/include/body_onload.inc");
        echo $body_onloadF;
    }
}
...
function themeindex($aid, $informant, $time, $title, $counter, $topic, $thetext, $notes, $morelink, $topicname, $topicimage, $topictext, $id)
{
    ...
    elseif (file_exists("themes/default/view/index-news.html"))
        $inclusion = "themes/default/view/index-news.html";
    else {
    ...
    $npds_METALANG_words = array(
        ...
        "'!N_date_m!'i" => \PHP81_BC\strftime("%B", $time, getLocale()),
...
function themearticle($aid, $informant, $time, $title, $thetext, $topic, $topicname, $topicimage, $topictext, $id, $previous_sid, $next_sid, $archive)
{
    ...
    elseif (file_exists("themes/default/view/detail-news.html"))
        $inclusion = "themes/default/view/detail-news.html";
    else {
...
function themesidebox($title, $content)
{
    ...
    if (file_exists("themes/" . $theme . "/view/bloc-left.html") and ($bloc_side == "LEFT"))
        $inclusion = 'themes/' . $theme . '/view/bloc-left.html';
    if (!$inclusion) {
        if (file_exists("themes/" . $theme . "/view/bloc.html"))
            $inclusion = 'themes/' . $theme . '/view/bloc.html';
        elseif (file_exists("themes/default/view/bloc.html"))
            $inclusion = 'themes/default/view/bloc.html';
        else {
