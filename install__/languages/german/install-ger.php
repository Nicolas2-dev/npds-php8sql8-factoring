...
function ins_translate($phrase) {
 switch($phrase) {
  ...
  case "Le fichier 'config/cache.config.php' est introuvable !": $tmp = "Die Datei 'config/cache.config.php' fehlt !"; break;
  case "Le fichier 'config/config.php' est introuvable !": $tmp = "Die Datei 'config/config.php' fehlt !"; break;
  case "Le fichier 'config/filemanager.php' est introuvable !": $tmp = "Die Datei 'config/filemanager.php' fehlt !"; break;
  case "Le fichier 'logs/security.log' est introuvable !": $tmp = "Die Datei 'logs/security.log' fehlt !"; break;
  case "Le fichier 'storage/meta/meta.php' est introuvable !": $tmp = "Die Datei 'storage/meta/meta.php' fehlt !"; break;
  case "Le fichier 'modules/upload/config/upload.conf.php' est introuvable !": $tmp = "Die Datei 'modules/upload/config/upload.conf.php' fehlt !"; break;
  case "Le fichier 'storage/static/edito_membres.txt' est introuvable !": $tmp = "Die Datei 'storage/static/edito_membres.txt' fehlt !"; break;
  case "Le fichier 'storage/static/edito.txt' est introuvable !": $tmp = "Die Datei 'storage/static/edito.txt' fehlt !"; break;
  case "Le fichier de configuration a été écrit avec succès !": $tmp = "Die Konfigurationsdatei wurde erfolgreich geschrieben !"; break;
  case "Le fichier de configuration n'a pas pu être modifié. Vérifiez les droits d'accès au fichier 'config/config.php', puis réessayez à nouveau.": $tmp = "Die Konfigurationsdatei konnte nicht geändert werden. Bitte überprüfen Sie die Rechte der 'config/config.php' und versuchen Sie es erneut."; break;
