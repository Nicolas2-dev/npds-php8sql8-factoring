...
function chgtheme()
{
    ...
    $theme = $ibid[0];
    if (array_key_exists(1, $ibid)) $skin = $ibid[1];
    else $skin = '';
    member_menu($userinfo['mns'], $userinfo['uname']);
    echo '
