...
include('themes/default/header.php');
      ...
      if($contributeurs[$i] !== '0') {
         if ($contri['user_avatar'] != '') {
            if (stristr($contri['user_avatar'],"users_private")) {
               ...
               if ($ibid=theme_image("forum/avatar/".$contri['user_avatar'])) {$imgtmp=$ibid;} else {$imgtmp="assets/images/forum/avatar/".$contri['user_avatar'];}
            }
         }
   ...
   if ($ibid=theme_image("forum/icons/new.gif")) {$imgtmpNE=$ibid;} else {$imgtmpNE="assets/images/forum/icons/new.gif";}
   do {
